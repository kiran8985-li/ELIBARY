 ...
 int i=0;
    ...
    int validationcount = 3;
     ...
     try{
        ...
        rs=st.executeQuery("select * from salesreport where uid='"+uid+"' AND dateoforder='"+dateFormat.format(date1)+"'");                       
                         
           // "select * from salesreport where uid='"+uid+"' AND dateoforder='"+dateFormat.format(date1)+"'");            
       // rs1=st2.executeQuery("select count(dateoforder) from salesreport where dateoforder="+dateFormat.format(date1));
