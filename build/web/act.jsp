...
<%
  ...
  int i=st.executeUpdate("insert into cart(ptype,pcost,quantity,pname)values('"+ptype+"','"+pcost+"','"+quantity+"','"+pname+"')");
  if(i!=0)
        response.sendRedirect("viewbooks.jsp?msg=Added to Cart Successfully");
